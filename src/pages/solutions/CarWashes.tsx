...
export default function CarWashes() {
  const title = 'Автомийки самообслуговування | Diwave Solutions';
  const description =
    'Виробництво + IoT/SCADA, телеметрія, платежі, CRM. Єдина платформа для управління мережами автомийок із прозорою аналітикою та інтеграціями.';
  ...
  const jsonLd = [
    {
      ...
      '@type': 'Service',
      name: 'Автомийки самообслуговування',
      description:
        'Комплексне рішення: обладнання, IoT/SCADA, телеметрія, прийом платежів, CRM та аналітика для мереж автомийок.',
      ...
      <main className="relative">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a href="/projects" className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 bg-white/90 text-black font-medium hover:bg-white transition">
                  Дивитися кейси
                </a>
                <a href="/solutions" className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 border border-white/30 text-white hover:bg-white/10 transition">
                  До каталогу рішень
                </a>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur">
                <SmartImage
                  srcFolder="/images/solutions/car-washes"
                  alt="Автомийки самообслуговування — рішення Diwave"
        ...
        <section className="mx-auto max-w-7xl px-6 py-12">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { t: 'IoT/SCADA', d: 'Онлайн-телеметрія, управління й оповіщення.' },
              { t: 'Платежі', d: 'QR, картки, Apple/Google Pay, локальні методи.' },
              { t: 'CRM/Аналітика', d: 'Звіти по виручці, відвідуваності та SLA.' }
            ].map((f) => (
