...
export default function Drones() {
  const title = 'Дрони та змагання (Gnizdo) | Diwave Solutions';
  const description =
    'Треки, турніри, телеметрія, суддівство, аналітика. Платформа для організації змагань і тренувань з розумною аналітикою.';
  ...
  const jsonLd = [
    {
      ...
      '@type': 'Service',
      name: 'Дрони та змагання (Gnizdo)',
      description:
        'Треки, турніри, телеметрія, суддівство, аналітика — повний стек для івентів і тренувань.',
      ...
      <main className="relative">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur">
                <SmartImage
                  srcFolder="/images/solutions/drones"
                  alt="Дрони та змагання — рішення Diwave"
        ...
        <section className="mx-auto max-w-7xl px-6 py-12">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { t: 'Треки', d: 'Конфігурації трас і таймінг.' },
              { t: 'Телеметрія', d: 'Дані польоту в реальному часі.' },
              { t: 'Суддівство', d: 'Інструменти для чесної конкуренції.' }
            ].map((f) => (
